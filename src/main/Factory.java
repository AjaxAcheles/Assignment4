...
public class Factory {
    ...
    public static TableInterface<AvatarInterface> avatarTableFactoryMethod() {
        if (avatarTable == null) {
    ...
    public static InheritingBridgeScenePainterInterface inheritingBridgeScenePainterFactoryMethod() {
    ...
    public static ObservableBridgeScenePainterInterface observableBridgeScenePainterFactoryMethod() {
